						...
						<div className={styles.itemWrapper}>
							<div className={styles.item}>
								<div classname={styles.img}>
									<img className={styles.imgFoto} src={PromotionBanner1} alt='Promotion' />
								</div>
								<div className={styles.timeDescrip}>Ends at 4:00 PM 12/30/2022</div>
								<div className={styles.gameTitle}>Daily Races</div>
							</div>

							<div className={styles.item}>
								<div classname={styles.img}>
									<img className={styles.imgFoto} src={PromotionBanner2} alt='Promotion' />
								</div>
								<div className={styles.timeDescrip}>Ends at 1.59 AM 1/1/2023</div>
								<div className={styles.gameTitle}>Stake.us Weekly Giveway</div>
							</div>

							<div className={styles.item}>
								<div classname={styles.img}>
									<img className={styles.imgFoto} src={PromotionBanner3} alt='Promotion' />
								</div>
								<div className={styles.timeDescrip}>Ends at 8:00 AM 12/23/2022</div>
								<div className={styles.gameTitle}>Slot Battle</div>
							</div>

							<div className={styles.item}>
								<div classname={styles.img}>
									<img className={styles.imgFoto} src={PromotionBanner4} alt='Promotion' />
								</div>
								<div className={styles.timeDescrip}>Ends at 8:00 AM 12/28/2022</div>
								<div className={styles.gameTitle}>Originals Challenge</div>
							</div>

							<div className={styles.item}>
								<div classname={styles.img}>
									<img className={styles.imgFoto} src={PromotionBanner5} alt='Promotion' />
								</div>
								<div className={styles.timeDescrip}>Ends at 4:00 PM 12/30/2022</div>
